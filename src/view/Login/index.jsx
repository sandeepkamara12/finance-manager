   ...
   return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-login h-screen pt-16 text-center relative">
         <div>
            ...
            <Link to='/' className='inline-flex items-center py-3 px-6 bg-white rounded-3xl mt-5 font-bold text-sm'><img src={Google} className='mr-2' />Continue with Google</Link>
