   ...
   return (
      <div className="p-5 bg-login h-screen text-center overflow-y-auto flex flex-wrap items-center justify-center">
         <div className='top-area flex justify-center flex-wrap flex-column items-center'>
            ...
            <h2 className="text-18 leading-24 font-semibold">Seamlessly manage your Finances</h2>
            ...
            <div className='w-full'>
               <Link to='/home' className='flex items-center justify-center py-3 px-6 bg-white rounded-full font-semibold text-13 leading-20 mb-4 w-full'>
