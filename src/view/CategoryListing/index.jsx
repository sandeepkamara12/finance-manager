            ...
            <div className="h-screen adjust-scrollbar  bg-white">
               <div className="dashboard-header fixed top-0 bg-white left-0 right-0 shadow-headerShadow">
                  <div className="expense-header border-b border-border">
                     <h1 className='uppercase font-semibold text-pink text-14 leading-20 flex flex-wrap items-center justify-between'>
                     ...
                     {listItems.map((item, index) => (
                        <li className="flex flex-wrap items-center justify-between py-1" key={index}>
                           <span className="expense-left-wrap w-4/6">
                              ...
                              <span className="text-12 capitalize">{`${index + 1}.  ${item}`}</span>
                           </span>
