            ...
            <div className="add-expense adjust-scrollbar overflow-auto h-full">
               ...
               <form onSubmit={formik.handleSubmit} className="px-5">
                  <div className="field-wrap mb-3 flex flex-wrap items-center">
                     <label htmlFor="date" className="text-16 leading-18 text-formLabel inline-block w-2/6">Date</label>
                     <input
                        id="date"
                        name="date"
                        type="date"
                  ...
                  <div className="field-wrap mb-3 flex flex-wrap items-center">
                     <label htmlFor="paymentType" className="text-16 leading-18 text-formLabel inline-block w-2/6">Account</label>
                     {/* <Select options={options} onChange={selectHandler} name="paymentType" id="paymentType" className='fields text-14 leading-18 text-black font-medium border-b border-border py-3 px-2 w-4/6 inline-block' /> */}
                     <input
                        id="paymentType"
                        name="paymentType"
                        type="text"
                  ...
                  <div className="field-wrap mb-3 flex flex-wrap items-center">
                     <label htmlFor="category" className="text-16 leading-18 text-formLabel inline-block w-2/6">Category</label>
                     <input
                        id="category"
                        name="category"
                        type="text"
                  ...
                  <div className="field-wrap mb-3 flex flex-wrap items-center">
                     <label htmlFor="amount" className="text-16 leading-18 text-formLabel inline-block w-2/6">Amount</label>
                     <input
                        id="amount"
                        name="amount"
                        type="number"
                  ...
                  <div className="field-wrap mb-3 flex flex-wrap items-center">
                     <label htmlFor="note" className="text-16 leading-18 text-formLabel inline-block w-2/6">Note</label>
                     <input
                        id="note"
                        name="note"
                        type="text"
